...
class CleanTest(TestCase):
    ...
    def test_clean_number_stats__map_visualization(self):
        ...
        self.assertEqual(
            cm.exception.params,
            {"dataset": ["A number dataset cannot be used with a map visualization"]},
        )
    ...
    def test_clean_map_stats__number_visualization(self):
        ...
        self.assertEqual(
            cm.exception.params,
            {"dataset": ["A map dataset cannot be used with a number visualization"]},
        )
    ...
    def test_calls_validate_dataset_params(self):
        ...
        with mock.patch(
            "statistics.blocks.validate_dataset_params"
        ) as validate_dataset_params:
            block.clean(
                {
                    "visualization": "statistics/visualizations/big-number.html",
                    "dataset": "no_params",
