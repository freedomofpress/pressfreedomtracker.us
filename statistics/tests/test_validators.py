...
class CleanTest(TestCase):
    ...
    def test_clean__no_params__gets_one_param(self):
        ...
        self.assertEqual(
            dict(cm.exception),
            {"params": ["No parameters may be supplied for this dataset"]},
        )
    ...
    def test_clean__one_param__gets_none(self):
        ...
        self.assertEqual(
            dict(cm.exception),
            {"params": ["At least 1 parameter must be supplied for this dataset"]},
        )
    ...
    def test_clean__one_param__gets_two_params(self):
        ...
        self.assertEqual(
            dict(cm.exception),
            {"params": ["At most 1 parameter may be supplied for this dataset"]},
        )
    ...
    def test_clean__two_params__gets_none(self):
        ...
        self.assertEqual(
            dict(cm.exception),
            {"params": ["At least 2 parameters must be supplied for this dataset"]},
        )
    ...
    def test_clean__two_params__gets_three_params(self):
        ...
        self.assertEqual(
            dict(cm.exception),
            {"params": ["At most 2 parameters may be supplied for this dataset"]},
        )
    ...
    def test_clean__kwargs__requires_kwargs(self):
        ...
        self.assertEqual(
            dict(cm.exception), {"params": ["Invalid param formatting: '200'"]}
        )
    ...
    def test_clean__kwargs__multiple_values(self):
        ...
        self.assertEqual(
            dict(cm.exception),
            {"params": ["Received multiple values for param 'value'"]},
        )
    ...
    def test_clean__kwargs__cleans_with_incident_filter__invalid_param(self):
        ...
        self.assertEqual(
            dict(cm.exception), {"params": ["Invalid parameter provided: value"]}
        )
    ...
    def test_clean__kwargs__cleans_with_incident_filter__invalid_date_param_value(self):
        ...
        self.assertEqual(
            dict(cm.exception),
            {"params": ["date_lower must be less than or equal to date_upper"]},
        )
    ...
    def test_clean__kwargs__cleans_with_incident_filter__invalid_param_value(self):
        ...
        self.assertEqual(
            dict(cm.exception),
            {"params": ["Invalid value for subpoena_statuses: hello"]},
        )
    ...
    def test_clean__kwargs__cleans_with_incident_filter__variable_param_value(self):
        ...
        self.assertEqual(
            dict(cm.exception),
            {"params": ["Value for venue should be wrapped in quotation marks"]},
        )
