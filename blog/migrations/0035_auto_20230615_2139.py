    ...
    for page in BlogPage.objects.all():
        if page.lead_image:
            page.lead_graphic = wagtail.blocks.StreamValue(
                ...
                stream_data=[("image", page.lead_image)],
            )
            page.save()
    ...
    for page in BlogPage.objects.all():
        if page.teaser_image:
            page.teaser_graphic = wagtail.blocks.StreamValue(
                ...
                stream_data=[("image", page.teaser_image)],
            )
            page.save()
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunPython(
            update_lead_graphic, reverse_code=migrations.RunPython.noop, elidable=True
        ),
        migrations.RunPython(
            update_teaser_graphic, reverse_code=migrations.RunPython.noop, elidable=True
        ),
    ]
