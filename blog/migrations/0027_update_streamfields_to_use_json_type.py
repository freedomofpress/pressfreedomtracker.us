...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('blog', '0026_copy_teaserimage_to_leadimage'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='body',
            field=wagtail.fields.StreamField([('rich_text', wagtail.blocks.RichTextBlock(icon='doc-full', label='Rich Text')), ('image', wagtail.images.blocks.ImageChooserBlock()), ('raw_html', wagtail.blocks.RawHTMLBlock()), ('tweet', wagtail.blocks.StructBlock([('tweet', wagtail.embeds.blocks.EmbedBlock())]))], use_json_field=True),
        ),
        migrations.AlterField(
            model_name='blogpage',
            name='body',
