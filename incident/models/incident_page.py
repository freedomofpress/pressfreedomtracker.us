...
class IncidentPage(MetadataPageMixin, Page):
    ...
    search_fields = Page.search_fields + [
        ...
        index.FilterField('exact_date_unknown'),
        index.FilterField('name'),
        index.FilterField('affiliation'),
        index.FilterField('city'),
        index.FilterField('lawsuit_name'),
        index.FilterField('border_point'),
        index.FilterField('third_party_in_possession_of_communications'),
        index.FilterField('state_id'),
        index.FilterField('target_id'),
        index.FilterField('commontag_id'),
        index.FilterField('arrest_status'),
        index.FilterField('status_of_charges'),
        index.FilterField('charge_id'),
        index.FilterField('slug'),
        index.FilterField('unnecessary_use_of_force'),
        index.FilterField('venue_id'),
        index.FilterField('equipment_id'),
        index.FilterField('status_of_seized_equipment'),
        index.FilterField('is_search_warrant_obtained'),
        index.FilterField('actor'),
        index.FilterField('stopped_at_border'),
        index.FilterField('stopped_previously'),
        index.FilterField('target_us_citizenship_status'),
        index.FilterField('denial_of_entry'),
        index.FilterField('nationality_id'),
        index.FilterField('did_authorities_ask_for_device_access'),
        index.FilterField('did_authorities_ask_for_social_media_user'),
        index.FilterField('did_authorities_ask_for_social_media_pass'),
        index.FilterField('were_devices_searched_or_seized'),
        index.FilterField('did_authorities_ask_about_work'),
        index.FilterField('assailant'),
        index.FilterField('was_journalist_targeted'),
        index.FilterField('charged_under_espionage_act'),
        index.FilterField('third_party_business'),
        index.FilterField('legal_order_type'),
        index.FilterField('status_of_prior_restraint'),
        index.FilterField('subpoena_type'),
        index.FilterField('subpoena_status'),
