...
def convert_tags_to_many_to_many(page_model, item_model, relation_name):
    for page in page_model.objects.all():
        ...
        # snippet.
        tmp_relations = getattr(page, "_tmp_" + relation_name).through.objects.filter(
            content_object=page
        )
...
def migrate_targets(apps, schema_editor):
    ...
    convert_tags_to_many_to_many(
        IncidentPage, Target, "targets_whose_communications_were_obtained"
    )
...
def migrate_politicians_or_public(apps, schema_editor):
    ...
    convert_tags_to_many_to_many(
        IncidentPage, PoliticianOrPublic, "politicians_or_public_figures_involved"
    )
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RemoveField(model_name="incidentpage", name="_tmp_tags"),
        ...
        migrations.RemoveField(model_name="incidentpage", name="_tmp_targets"),
        ...
        migrations.RemoveField(model_name="incidentpage", name="_tmp_current_charges"),
        migrations.RemoveField(model_name="incidentpage", name="_tmp_dropped_charges"),
        ...
        migrations.RemoveField(
            model_name="incidentpage", name="_tmp_target_nationality"
        ),
