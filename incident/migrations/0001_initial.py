    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "affiliation",
                    models.CharField(
                        blank=True, default="Independent", max_length=255, null=True
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="incident_nationalitytag_items",
                        to="taggit.Tag",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="incident_politiciansorpublictag_items",
                        to="taggit.Tag",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="incident_targetscommunicationsobtainedtag_items",
                        to="taggit.Tag",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="incident_targetstag_items",
                        to="taggit.Tag",
                    ),
                ),
            ],
        ...
        migrations.AddField(
            ...
            field=modelcluster.fields.ParentalManyToManyField(
                blank=True,
                related_name="_incidentpage_related_incidents_+",
                to="incident.IncidentPage",
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="incident_droppedchargestag_items",
                to="taggit.Tag",
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="incident_currentchargestag_items",
                to="taggit.Tag",
            ),
        ),
    ]
