...
class TestTemplateTags(TestCase):
    ...
    def test_add_as_string_single_coercion_error_defaults_to_addition(self):
        ...
        self.assertEqual(
            add_as_string(part_string, bad_object), "I was added to something"
        )

    def test_richtext_aside(self):
        paragraph_aside = (
            '<p data-block-key="89kgh">This is paragraph with <b>bold text</b></p>'
        )
        ...
        heading_aside_with_span = (
            '<h3 data-block-key="89agh"><span>This is a heading</span></h3>'
        )
