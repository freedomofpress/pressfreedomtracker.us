...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='methodology',
            field=wagtail.core.fields.RichTextField(blank=True, default='', validators=[common.validators.TemplateValidator()]),
            preserve_default=False,
        ),
        migrations.AlterField(
            model_name='quickfact',
            name='body',
            field=wagtail.core.fields.RichTextField(validators=[common.validators.TemplateValidator()]),
        ),
        migrations.AlterField(
