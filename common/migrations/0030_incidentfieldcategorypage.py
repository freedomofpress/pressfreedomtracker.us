                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("links", "links"),
                            ("equipment_seized", "equipment_seized"),
                            ...
                            (
                                ...
                                "target us citizenship status",
                            ),
                            ("denial_of_entry", "denial of entry"),
                            ...
                            (
                                ...
                                "did authorities ask for social media user",
                            ),
                            (
                                "did_authorities_ask_for_social_media_pass",
                                "did authorities ask for social media pass",
                            ),
                            (
                            ...
                            ("subpoena_status", "subpoena status"),
                            (
                                "held_in_contempt",
                                "If subject refused to cooperate, were they held in contempt?",
                            ),
                            ("detention_status", "detention status"),
                            (
                                "third_party_in_possession_of_communications",
                                "third party in possession of communications",
                            ),
                            ...
                            ("targets", "Targets (Journalists/Organizations)"),
                            ("tags", "Tags"),
                            ...
                            (
                                ...
                                "Journalists/Organizations whose communications were obtained in leak investigation",
                            ),
                            (
                                "politicians_or_public_figures_involved",
                                "Politicians or public officials involved",
                            ),
                        ],
                        max_length=255,
                    ),
