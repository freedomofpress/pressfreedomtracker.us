function collapsibleCard(card) {
	function toggleCard() {
		if (card.classList.contains("closed")) {
			...
			const buttonTextEl = card.querySelector(
				".incident-card-collapsible__toggle-button-text",
			);
	...
	card
		.querySelectorAll(".incident-card-collapsible__toggle-button")
		.forEach((ele) => ele.addEventListener("click", toggleCard));
}
