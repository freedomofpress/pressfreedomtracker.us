...
describe('processing html', () => {
	...
	test('converts multiple lines of text at once', () => {
		...
		let expected = `<meta charset="utf-8"><p dir="ltr"><span>She said “[t]his is good.”</span></p><p dir="ltr"><span>“She </span><span style="font-style:italic;">didn’t</span><span style="font-style:normal;">!”</span></p>`
		expect(curlify.html(input)).toBe(expected)
	})
})
