...
import { TOGGLE_PARAMETER_ITEM, SET_PARAMETER } from "../lib/actionTypes";
...
export default function CategoryFilter({
	...
	function onCategoryClick(d) {
		...
		updateFilters({
			...
			payload: { item: targetCategory, filterName: "categories" },
		});
		// Fire matomo event
	...
	return (
		<div className="filters__form--fieldset">
			<div className="category-graph">
				<p className="category-graph--label" id="categories-graph-label">
				...
				>
					...
					<AnimatedDataset
						...
						attrs={{
							...
							fill: (d) =>
								selectedCategories.has && selectedCategories.has(d.category)
									? "#F2FC67"
									: "black",
							width: barsWidth,
							stroke: "black",
			...
			{filterDefs.map((filterDef) => (
				<CategorySection
					...
					isOpen={
						!!selectedCategories.has && selectedCategories.has(filterDef.title)
					}
