...
export default function USMap({
	...
	const scaleDomainMax =
		domainMax || d3.max(dataset, (d) => d.numberOfIncidents) || 1;
				...
				>
					...
					{fullSize &&
						(() => {
							...
							const isMaxClamped =
								domainMax && domainMax > 0 && maxValue > domainMax;
							...
							const showMin =
								minValue !== maxValue && minMarkerRadius !== maxMarkerRadius;
							const lineEndForLabel = (text) =>
								labelRightX - text.length * numberCharWidth - 2;
							return (
								<g
									role="img"
