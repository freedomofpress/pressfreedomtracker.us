...
export function HomepageMainCharts({ data: dataset, isLastSixMonths, selectedYear, width }) {
  ...
  const chartWidth = dimensions.width > 970 ? dimensions.width / 3 : dimensions.width
